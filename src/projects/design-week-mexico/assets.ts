...
export const ASSETS = {
  ...
  carousel1: cldImg('CONSTANZASCHWARTZ-projects-designweekmexico-carrousel-1_m5cdjj'),
  carousel2: cldImg('CONSTANZASCHWARTZ-projects-designweekmexico-carrousel-2_nsoiwl'),
  carousel3: cldImg('CONSTANZASCHWARTZ-projects-designweekmexico-carrousel-3_ygydv8'),
  carousel4: cldImg('CONSTANZASCHWARTZ-projects-designweekmexico-carrousel-4_ebu1pg'),
  carousel5: cldImg('CONSTANZASCHWARTZ-projects-designweekmexico-carrousel-5_qud4z9'),
  carousel6: cldImg('CONSTANZASCHWARTZ-projects-designweekmexico-carrousel-6_wgxnjt'),
} as const